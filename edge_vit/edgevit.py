#copy from https://github.com/saic-fi/edgevit/blob/master/src/edgevit.py#L170
...
class PatchEmbed_bj(nn.Module):
    """ Image to Patch Embedding
    """
    def __init__(self, height, width, in_chans, embed_dim, patch_size=2):
        super().__init__()
