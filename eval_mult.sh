...
#  CUDA_VISIBLE_DEVICES=0 python evaluate_depth.py --load_weights_folder /mnt_2/tmp/lite_mab_no_residual_2x_2023-05-29\ 16:57:40/models/weights_$var --eval_mono --lite  --global_block_type MAB --gpu_num 0 --save_pred_disps
 CUDA_VISIBLE_DEVICES=0 python evaluate_depth.py --load_weights_folder /mnt_2/tmp/lite_mab_adamw_together_2x/models/weights_$var --eval_mono --lite --global_block_type MAB --gpu_num 0 --mab_se #--save_pred_disps
...
#   CUDA_VISIBLE_DEVICES=0 python evaluate_depth.py --load_weights_folder /mnt_2/tmp/lite_max_2023-06-04\ 22:33:10/models/weights_$var --eval_mono --lite --global_block_type Max --gpu_num 0 --save_pred_disps
done
